...
<div class="m-0 p-0" style="background-color: #ffd000">

  <div class="row">
    <div class="col-md-12 toolBarStyle">
      
      <button type="button" class="btn btn-secondary btn-sm font-weight-bold mr-1">
        <router-link to="/allproducts" class="nav-link py-1 px-0 m-0" style="font-size: 12px; color: #ffffff"><i class="far fa-heart"/>全部商品</router-link>
      </button>
    ...
    <div class="col-md-12">
      <div>
        <div class="productTitleOutside">
          <h2 class="productTitle" style="margin-left: 30px">我的最愛</h2>
        </div>
  ...
  <div class="row mt-4">
    <div class="col-md-4 mb-4" v-for="item in likeProduct" :key="item.id" v-if="item.title.indexOf(keyword)!=-1">
  ...
  created() {
    ...
    $(function(){
      ...
      var timer = setInterval(function(){
        ...
        $(".jumbotronStyle004").text(percent+"%");
